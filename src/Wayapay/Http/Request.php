...
class Request
{
    ...
    public function __construct($wayapayObj = null)
    {
        $this->response = new Response();
        $this->response->setRequestObject($this);
        $this->wayapayObj = $wayapayObj;
        $this->response->forApi = !is_null($wayapayObj);
    ...
    {
        if (isset($this->wayapayObj) && !$this->wayapayObj->use_guzzle) {
    ...
    {
        if (!Wayapay::$fallback_to_file_get_contents) {
            return;
        }
